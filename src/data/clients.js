...
export const newAllClients = resolveMediaDeep([
  ...
  defineClient({
    ...
    slug: "ibh",
    group: "featured",
    thumbnail: "/clients/ibh/logo.png",
    title: "Indian Biere House",
    description: "BRANDING & IDENTITY · PACKAGING",
    content: "/clients/ibh/content.jpeg",
  }),
  defineClient({
    id: 5,
    slug: "itc",
    group: "featured",
    thumbnail: "/clients/itc/logo.png",
    title: "Indian Tiffin Club",
    description: "BRANDING & IDENTITY · PACKAGING",
    content: "/clients/itc/content.png",
  }),
  defineClient({
    id: 5,
    slug: "ibh",
    group: "featured",
    thumbnail: "/clients/palms/logo.png",
    title: "The Palms",
    description: "BRANDING & IDENTITY · PACKAGING",
    content: "/clients/palms/content.jpeg",
  }),
  defineClient({
    id: 6,
    slug: "brahma",
    group: "featured",
    thumbnail: "/clients/brahma/logo.png",
    title: "Brahma Brews",
    description: "BRANDING & IDENTITY · PACKAGING",
    content: "/clients/brahma/content.jpeg",
  }),
  defineClient({
    id: 7,
    slug: "holy-kicks",
    group: "featured",
    thumbnail: "/content/branding/logos/logo-06.png",
    title: "Holy Kicks",
    description: "BRANDING & IDENTITY · PACKAGING",
    content: "/clients/holy-kicks/content.png",
  }),
]);
